...
// ** PostEvents 를 입력으로 받고 PostStates 를 출력한다
class PostBloc extends Bloc<PostEvent, PostState> {
  final http.Client _httpClient;
  PostBloc({required http.Client httpClient}) : _httpClient = httpClient, super(const PostState()) {
    /// todo: register on<PostFetched> event
    on<PostFetched>(_onFetched, transformer: throttleDroppable(throttleDuration));
  }
